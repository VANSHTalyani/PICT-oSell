          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-grow">
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-lg border-2 border-indigo-100 dark:border-gray-700 focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900 transition-all bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              />
            ...
            <button
              ...
              className={`p-3 rounded-lg border-2 transition-all ${
                showFilters
                  ? 'border-indigo-600 text-indigo-600 bg-indigo-50 dark:bg-indigo-900/30 dark:border-indigo-400 dark:text-indigo-300'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 mt-4 bg-white dark:bg-gray-800 rounded-lg border-2 border-indigo-100 dark:border-gray-700 animate-fadeIn shadow-sm">
            <div className="space-y-2">
              ...
              <select
                ...
                className="w-full px-4 py-2 rounded-lg border-2 border-indigo-100 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-indigo-300 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900 transition-all"
              >
          ...
          {sortedProducts.map((product) => (
            ...
            >
              ...
              <div className="relative aspect-square mb-4 overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-700">
                ...
                {/* Quick Actions */}
                <div className="absolute top-4 right-4 flex flex-col gap-2 transform translate-x-10 opacity-0 hover:translate-x-0 hover:opacity-100 transition-all duration-300">
                  <button
              ...
              <div className="space-y-3">
                <h3 className="font-medium text-lg text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors line-clamp-2">
                  {product.title}
                </h3>
